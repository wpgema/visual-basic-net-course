Public Class DtMahasiswa
    Public Sub Tampil_Data()
        If Me.ListView1.Columns.Count <= 0 Then
            ...
            Me.ListView1.Columns.Add("NIM", 150, HorizontalAlignment.Center)
...
gagal:
    ...
    Private Sub HapusToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles HapusToolStripMenuItem.Click
        Me.Tag = ListView1.SelectedItems(0).SubItems(1).Text
        If MessageBox.Show("sure this data want to be deleted ?", "", MessageBoxButtons.YesNo) = Windows.Forms.DialogResult.Yes Then
            Call Koneksi()
            Dim Hapus As String = "delete from mahasiswa where NIM='" & Me.Tag & "'"
